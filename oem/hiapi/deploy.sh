#!/bin/bash
# func: pull code and run hiapi container with 3 app
# date: 2018-01-03
# author: zhouwei
...
# pull code
old_version_num=$(su - tongxin -c "cd $script_home/txhiapi && git rev-parse HEAD")
...
new_version_num=$(su - tongxin -c "cd $script_home/txhiapi && git rev-parse HEAD")
